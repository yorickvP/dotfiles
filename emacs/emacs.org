...
(defun +y-map-theme (color-scheme)
  (cond ((eq color-scheme 'light) 'sanityinc-tomorrow-day)
        ((eq color-scheme 'dark) 'sanityinc-tomorrow-night)))
(defun +y-applicable-theme ()
  (+y-map-theme (intern (with-temp-buffer 
...
(use-package color-theme-sanityinc-tomorrow
  :config
  (load "/home/yorick/dotfiles/emacs/theme.el")
  (+y-reload-theme nil))
#+END_SRC
** Cleaner frames
#+BEGIN_SRC emacs-lisp
